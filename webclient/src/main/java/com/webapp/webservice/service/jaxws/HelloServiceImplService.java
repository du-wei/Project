 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://jaxws.service.webservice.webapp.com/", wsdlLocation = "http://localhost:8080/webservice/service?wsdl")
public class HelloServiceImplService extends Service {
	...
	public HelloService getHelloServiceImplPort() {
		return super.getPort(new QName(
				"http://jaxws.service.webservice.webapp.com/",
				"HelloServiceImplPort"), HelloService.class);
	}
	...
	public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
		return super.getPort(new QName(
				"http://jaxws.service.webservice.webapp.com/",
				"HelloServiceImplPort"), HelloService.class, features);
	}
