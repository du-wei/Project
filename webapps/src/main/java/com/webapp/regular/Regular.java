...
public class Regular {
	 ...
	 *
	 * (.{3})(?<!g) 相当于组(.{3})的结尾一定不是g，并且g不算在group(0)里
	 * (?<!g)(.{3}) 相当于组(.{3})的前面一定不是g，并且g不算在group(0)里
	 *
