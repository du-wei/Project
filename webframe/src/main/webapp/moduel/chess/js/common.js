...
window.onload = function(){
	...
	var prev = "/moduel/chess/";
	com.getData(prev + "js/gambit.all.js",
		function(data){
		com.gambit=data.split(" ");
		AI.historyBill = com.gambit;
	})
	com.getData(prev + "js/store.js",
		function(data){
...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = prev + "img/"+stype+"/bg.png";

	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = prev + "img/"+stype+"/dot.png";

	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = prev + "img/"+stype+"/"+ com.args[i].img +".png";
	}

	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = prev + "img/"+stype+"/r_box.png";

	document.getElementsByTagName("body")[0].style.background= "url(" + prev + "img/"+stype+"/bg.jpg)";
