...
public class HttpTools {
	...
	static {
		...
		RequestConfig config = RequestConfig.custom().setConnectionRequestTimeout(200).build();

		client = HttpClients.custom().setConnectionManager(cm).setMaxConnTotal(200).setDefaultRequestConfig(config)
		        .build();
	}
